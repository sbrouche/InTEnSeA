#ifndef MENUMEMOIRE_H
#define MENUMEMOIRE_H
...
class MenuMemoire : public QWidget
{
    Q_OBJECT
public:
    explicit MenuMemoire(MemoireService *memoireService ,Fenetre *,QWidget *parent = nullptr);
    void redirection();
    void diaporama();
